function generateBubbles(e) {
    ...
    var s, o = window.innerWidth, i = window.innerHeight, r = e.sessions[e.sessions.currentType].durations;
    if ($.inArray("HAVE A-BREAK", r) < 0 && $.inArray("SKIP-BREAK", r) < 0 && (e.flags._isBreakTime ? r.push("SKIP-BREAK") : r.push("HAVE A-BREAK")),
    1 === r.length)
        s = 0;
    else {
    ...
    m.append("text").text(function(e) {
        ...
        e.each(function() {
            for (var e = d3.select(this), t = e.text().split("-").reverse(), a = t.pop(), s = [], n = 0, o = e.attr("y"), i = parseFloat(e.attr("dy")), r = e.text(null).append("tspan").attr("x", 0).attr("y", o).attr("dy", i + "em"); a; ) {
                if (s.push(a),
                r.text(s.join(" ")).attr("dy", function() {
...
var Notifications = function() {
    var a, e = window.Notify.default, t = new e("Cuckoo!",{
    ...
    return {
        ...
        inAppNotification: function(e, t) {
            e && $(".js-notification").html('<div class="notification">' + e + "</div>"),
...
function updateActivity(e) {
    ...
    for (var s = 0; s < t.length; s++) {
        var n = $('<div class="activity__item"><div class="activity__info">' + t[s].message + '<span class="activity__time">' + t[s].time_since + "</span></div></div>")
          , o = t[s].user;
        n.prepend(createAvatarElement(o)),
        a.append(n)
    }
}
function updateRoadmap(e) {
    ...
    e.sessions.forEach(function(e) {
        ...
        e.current && t.addClass("isCurrent"),
        e.finished && t.addClass("isFinished"),
        a.append(t)
    })
}
...
function updateSettings(e) {
    function t(e, t) {
        ...
        for (var n = 0; n < e.length; n++)
            a = '<div class="sidebar__session">' + e[n] + '<div class="js-remove-session sidebar__delete" onclick="removeSession(this)"><img src="https://cuckoo.team/images/icon-close-circle.svg"></div></div>',
            $(s).append(a)
    }
